<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" style="width:100% !important;">
...
<head>
    ...
    <head>
        ...
        <style>
            ...
            ol,p,ul{font-family:sans-serif;font-size:14px;font-weight:400;margin:0;margin-bottom:15px}
            ol li,p li,ul li{list-style-position:inside;margin-left:5px}
            ...
            table[class=body] a,table[class=body] ol,table[class=body] p,table[class=body] span,table[class=body] td,table[class=body] ul{font-size:16px!important}
            table[class=body] .article,table[class=body] .wrapper{padding:10px!important}
...
<body marginwidth="0" marginheight="0" offset="0" topmargin="0" leftmargin="0"
    style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;width:100% !important;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;margin-right:0;margin-left:0;padding-right:0;padding-left:0;font-family:&#39;Coolvetica&#39;;">
                            ...
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>Olá {{$name}},</p>
                                            <p>Você solicitou redefinição de senha.<br />
                                                Por favor, clique no botão abaixo para validar.</p>
                                            <br>
                                            <p>Se não desconsidere esse Email.<br />
                                            <br>
                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <td align="center">
                                                            <table role="presentation" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="/{{$token}}"
                                                                                target="_blank">Redefina sua senha</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
